 ...
 *
 * System prompt + temperature + maxTokens now owned by
 * agents/chat_episode_extractor.ts.
 */
...
async function extractFromTranscript(
  ...
  try {
    // Prompt + temperature + maxTokens come from agents/chat_episode_extractor.ts.
    const result = await runAgent('chat_episode_extractor', { input: transcript });
