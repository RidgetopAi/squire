...
export const mandrelDecisionRecordToolName = 'mandrel_decision_record';

export const mandrelDecisionRecordToolDescription =
...
export const mandrelDecisionRecordToolParameters = {
  type: 'object',
  properties: {
    decisionType: {
      type: 'string',
...
export const mandrelDecisionRecordToolHandler: ToolHandler<DecisionRecordArgs> = async (args) => {
...
export const mandrelDecisionSearchToolName = 'mandrel_decision_search';

export const mandrelDecisionSearchToolDescription =
  'Search past technical decisions. Find decisions by query, type, or impact level.';

export const mandrelDecisionSearchToolParameters = {
  type: 'object',
  properties: {
    query: {
      type: 'string',
...
export const mandrelDecisionSearchToolHandler: ToolHandler<DecisionSearchArgs> = async (args) => {
