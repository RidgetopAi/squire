...
export const mandrelSmartSearchToolName = 'mandrel_smart_search';

export const mandrelSmartSearchToolDescription =
...
export const mandrelSmartSearchToolParameters = {
  type: 'object',
  properties: {
    query: {
      type: 'string',
...
export const mandrelSmartSearchToolHandler: ToolHandler<SmartSearchArgs> = async (args) => {
